<template>
  <div>
    ...
    <div class=" text-container " id="graphs1">
      <div class="text-column content">
        ...
        <p class="is-size-7 hast-text-weight-bold" style="line-height:120%;">
          ...
          circunscrito a un momento del año determinado y se centra sólo en uno
          de los aeropuertos de España, y en sus vuelos de salida. No es un trabajo académico y
    ...
    <div class=" text-container " >
        ...
        <div class="content ">
          ...
          <ul class="traditional">
            ...
            <li>
              ...
              Estos datos son más difíciles de encontrar, pero calculando sale
              un 5%
              <b-collapse
                :open="false"
                position="is-bottom"
      ...
      <section class="section text-column content">
        ...
        <ul>
          ...
          <li>
            ...
            velocidad por todo el país que es deficitaria y hay que exprimir
          </li>
          <li>
            Es un cambio relativamente fácil que no supone un golpe a nuestro
            "modo de vida"
          </li>
          <li>Pero a la vez manda un mensaje de autolimitación: ya no vale todo.</li>
        </ul>

        Para reducir el impacto de los trayectos internacionales no hay alternativa: menos gente de viaje y menos vuelos.
      ...
      <section class="text-column content" id="metodologia">
         ...
         <ul>
           ...
           <li> Este proyecto es un experimento, un juego, no un paper científico, si crees que hay datos que no son verosímiles por favor escríbeme</li>
        </ul>
      </section>
    </div>
    <div id="footer"></div>
